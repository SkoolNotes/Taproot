...
What's even cooler? this principle applies to the length of the moving frame as well. That, at a moving frame, $D = D' \gamma$, where $D$ is distance between two places to the non-moving frame, and $D'$ the distance between those two places to the moving frame.
