...
Brands grapples with the truly global nature of the Cold War by exploring where the Cold war is not. Even in a scenario where the United States did not meddle, it is still perceived as the puppet master orchestrating major changes. The extent of the Cold War reaches farther than reality — the Cold War was so truly global that it is now assumed to be the cause 
