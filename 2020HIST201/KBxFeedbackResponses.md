...
As for problem 2 with the repeated values, given that each group of values is repeating some number as opposed to repeating the same collection of different numbers, their will be one