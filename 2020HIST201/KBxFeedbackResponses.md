...
As for the gradients, without either large kernels or some type of memory or hidden cell state, I don't know how to make filters what would check for the gradients consistent between sections. If you
