...
Effective mitigation of plague requires a level of organization higher than a single person can provide. Instead, it requires protection from the state, perhaps taking the form of sanitation mandates or information as opposed to the formation of an army. This protection would require extraction, which, with the same logic as originally applied with war making, would lead to state making. This 
