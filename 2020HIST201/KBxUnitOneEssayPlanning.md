...
A way states control their people is through a shared, commonly theological, ideology. When a competing ideology is introduced, this threatens the state's control, and thus, the state attempts to crush them. This process is scene time and time again throughout history, but perhaps one of the most notable examples is the Protestant Reformation. 
