...
*** industrialization -> bigger militaries
   ...
   Contries tend to grow their military as they industrialize, if only for defensive purposes. As Germany doubled it's military population, nearby countries grew wary. As surpassed power and a failing empire, Russia and France grew wary of the newfound power between them. They allied with Britain in 1904 and 1907 respectively to
