...
*** TODO bad news bears in the Balkans (sets it off)

** TODO BP2: governments keep the war
*** mutinies
*** government ideas
**** TODO 'just outlast others' < shipping blockades
***** 4.14.8  "to starve out the enemy and ruin their economy was precisely the purpose"
**** war on others' turf
...
** TODO how much of bad news bears in the balkans is needed        :question:

** TODO can I cite external sources / tables n stuff               :question:

** TODO how to cite stuff in class?                                :question:

*** people just trying to outlast others -- need explicit or analyze from shipping?

*** idea of war on others turf

** TODO what are you looking for in the intro / conclusion?        :question:
