...
** TODO argument connects to broader trends and specific moments. needs a "so what" to demonstrate it's relevance
...
*** primary sources
	These writers inflated the national identity and glorified warfare, creating a populous that is itching to fight. As troops are amassed and
*** germany wants a spot in the sun
*** security dilemma => people think war is coming (level 3 influence)
** BP2: governments keep the war
*** mutinies
*** government ideas
**** TODO 'just outlast others' < shipping blockades
**** war on others' turf
** BP3: greater power could've stopped the reaction at any time
