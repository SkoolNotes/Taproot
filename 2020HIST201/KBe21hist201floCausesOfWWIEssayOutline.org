...
** TODO BP1: level 3 security dilemma/cult of the offensive puts everyone on edge
   Reinforcing international incentives such as the security dilemma and cult of the offensive put each of the international powers on edge
...
*** the security dilemma
	As countries formed aliances and grew their militaries, opposing parties were forced to keep up in the arms race. This so called "security dilemma" doubled the number of military and navel personel worldwide in the 30 years between the German unification and the war, and nearly quadrupled the global warship tonnage (Kennedy, Table 19-20).
