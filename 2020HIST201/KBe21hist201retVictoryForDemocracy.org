...
** intro
   ...
   However, as Aristotle defines in /Politics/, the democracy is a deviation from a more pure form of government---the constitutional government or polity---in which the many rule in the interests of the poor. The term democracy is often used in modern times as a archetypal
