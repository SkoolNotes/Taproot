...
* Proof
  ...
  We can also rewrite the second condition for easier manipulation. "If $w \in \onull T$ then $w \notin \orange T$" is the same as:

  \[\begin{aligned}
  \left( w \in \onull T \right) &\implies \left( \nexists v : Tv = w \right)\\
