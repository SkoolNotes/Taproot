...
** connection to Heisenberg uncertainty principle
*** the fourier transform graph says something about correlation
**** eg. for a pure signal (sine 5Hz), a winding frequency of $\xi=5.01$ will come out pretty high on the almost-fourier-transform graph.
