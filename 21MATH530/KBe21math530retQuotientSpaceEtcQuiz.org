...
* Why "product" and "quotient" are used to describe these operations
  ...
  It is like removing a subset of the basis (those that form a basis of $U$), where the basis itself can be represented as the cartesian product $\mathbb F^n$ (where $n$ is the dimension of $V$).
