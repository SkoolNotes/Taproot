...
** $\int e^{2x} \cos 3x dx$
   ...
   \[\begin{aligned}
   \int e^{2x} \cos 3x dx &= \cos 3x \frac{1}{2}e^{2x} +\int \sin 3x \frac{1}{2}e^{2x} dx\\
   &= \cos 3x \frac{1}{2}e^{2x} + \sin 3x \frac{1}{4}e^{2x} - \int \cos 3x \frac{1}{4}e^{2x} dx\\
   &= \cos 3x \frac{1}{2}e^{2x} + \sin 3x \frac{1}{4}e^{2x} - \frac{1}{4} \int e^{2x} \cos 3x dx\\
   \frac{5}{4} \int e^{2x} \cos 3x dx &= \cos 3x \frac{1}{2}e^{2x} + \sin 3x \frac{1}{4}e^{2x}\\
   \int e^{2x} \cos 3x dx &= \frac{4}{10} \left( \cos 3x e^{2x} + \sin 3x \frac{1}{2}e^{2x} \right)
   \end{aligned}\]
