...
** $\int e^{2x} \cos 3x dx$
   ...
   \frac{7}{4} \int e^{2x} \cos 3x dx &= \cos 3x \frac{1}{2}e^{2x} + 3 \sin 3x \frac{1}{4}e^{2x}\\
   \int e^{2x} \cos 3x dx &= \frac{4}{7} \left( \cos 3x \frac{1}{2}e^{2x} + 3 \sin 3x \frac{1}{4}e^{2x} \right)\\
   &=\frac{4}{7} \left( \cos 3x \frac{1}{2}e^{2x} + 3 \sin 3x \frac{1}{4}e^{2x} \right)
   \end{aligned}\]
