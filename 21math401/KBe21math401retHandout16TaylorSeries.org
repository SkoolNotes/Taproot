...
** find $1-\frac{x^2}{3!}+\frac{x^4}{5!}-\frac{x^6}{7!}+\cdots$
   ...
   \[\begin{aligned}
\frac{d}{dx} \frac{x \cos x - \sin x}{x^2} = \frac{x^2 \left( -x \sin x + \cancel{\cos x - \cos x \right) - \left( x \cos x - \sin x \right)(2x) }}{x^4} = \frac{x^2 \left( -x \sin x + \cancel{\cos x - \cos x \right) - \left( x \cos x - \sin x \right)(2x) }}{x^4}
   \end{aligned}\]
   is positive at zero.
