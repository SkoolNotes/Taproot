...
* slicing pizza into three using parallel cuts
  ...
  \[\begin{aligned}
  2\int_{-7}^{x} \sqrt{7^2 - t^2} dt &= \int_{t}^{7} \sqrt{7^2 - t^2} dx\\
  2\int_{-7}^{x} \sqrt{7^2 - t^2} dt &- \int_{t}^{7} \sqrt{7^2 - t^2} dx = 0\\
  2\int_{-7}^{x} \sqrt{7^2 - t^2} dt &+ \int_{7}^{t} \sqrt{7^2 - t^2} dx = 0\\
  \end{aligned}\]
