...
*** aluminum allow then diposited on top of the layer
*** mask 7 patterns aluminum to wire together individual transistors
*** more layers of wiring are often produced, each differing layer created like this
**** oxy dioxide to insulate
**** masking and etching photolithograthy to create contact holes
**** more tungsten plugs for holes
**** deposition and patterning of new upper level of aluminimum
*** after all metal levels, final nitride is connected
*** only the bonding pads are etched away in final mask
** design
*** circuit design
