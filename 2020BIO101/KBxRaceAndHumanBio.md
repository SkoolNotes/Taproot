...
I don't view the entirety of `science` or `medicine` as entities. Science cannot act. I would argue instead that `science` is a way of viewing the world, and perhaps the knowledge collected from this lens.
